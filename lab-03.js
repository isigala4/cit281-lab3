...
console.log(11, reverseString("abc")+ concatenateString("abc"));
...
for (let prop in car) {
    if (car.hasOwnProperty(prop)) {
        ...
        //car.prop will not work// car[",make"]
    }
}
...
console.log(12, concatenateString("cba", reverseString("cba")));
